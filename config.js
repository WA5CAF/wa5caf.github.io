...
const aURL = [
  ...
  [
    "2196F3",
    "RADAR",
    "https://www.weatherbug.com/maps/?layerId=Radar.Global&center=32.854136843693226,-96.95745668940023,5.979489993220294",
    "1",
    "R"
  ],
  ...
  [
    "2196F3",
    "WINDS",
    "https://earth.nullschool.net/#current/wind/surface/level/orthographic=-100.02,33.47,1065/loc=-97.204,32.842",
    "1",
    "R",
  ],
];
...
const aIMG = [
  ...
  [
    "SATELLITE TEXAS",
    "https://cdn.star.nesdis.noaa.gov/GOES16/ABI/SECTOR/sp/02/GOES16-SP-02-600x600.gif",
  ],
